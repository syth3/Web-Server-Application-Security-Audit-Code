...
def gather_input():
    ...
    -------
    Input_Args
        Input_Args object encapsulating all of the command line arguments given
    """
    ...
    # HTTPS connection
    # Note: this section is commented out because of the requirements for the assignment to only have two command line arguments
    # elif len(sys.argv) == 5:
    #     ip_address = sys.argv[1]
    #     port = sys.argv[2]
